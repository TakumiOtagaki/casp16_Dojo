...
# working dir
workdir=/large/otgk/casp/casp16/R0254/multimer/n3_1 # this dir should contain unformatted/*.pdb
...
for pdb_file in "${un_formatted_pdbs[@]}"; do
    ...
    python $repo_dir/utils/add_residue_to_rna_.py -pdb ${workdir}/unformatted/${pdb_base}.pdb \
     -f ${workdir}/a.fa -ss ${workdir}/a.secstruct \
...
# merging
python  $repo_dir/utils/merge_formatted_5structure.py -i ${workdir}/formatted -o ${workdir}/merged_for_submission/R0254.merged.formatted.pdb -t ${CASP_ID}
echo "Done: formatted & merged pdb is created in $workdir/merged_for_submission/R0254.merged.formatted.pdb"
